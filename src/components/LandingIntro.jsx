...
export default function LandingIntro() {
  ...
  return (
    <div id="intro" className="relative rounded-md">
      <div className="rounded-md bg-gray-900">
        <header className="absolute inset-x-0  top-0 z-50 rounded-md ">
          <span className="sr-only">Alexis Page</span>
        </header>

        <div className="relative isolate overflow-hidden rounded-md pt-14">
          <Image
            src={image4}
            alt=""
            sizes={image1.size}
          ...
          <div className="mx-auto -mt-14 max-w-2xl py-32 sm:py-48 lg:py-56">
            <div className=" hidden sm:mb-8 sm:flex sm:justify-center">
              <div className="trelative rounded-full py-1 px-3 text-sm leading-6 text-gray-400 ring-1 ring-white/10 hover:ring-white/20">
                Announcing new coaching services.{' '}
                <Link href="coaching" className="font-semibold text-white">
            ...
            <div className="text-center">
              <h1 className="-mt-10 text-4xl font-bold tracking-tight text-white sm:text-6xl">
                Reach new heights with my coaching classes.
              </h1>
              <p className="mt-6 text-lg leading-8 text-gray-300">
                Elevate your performance with our gymnastics coaching classes
              </p>
